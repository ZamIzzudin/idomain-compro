...
export default function AboutPage() {
  ...
  return (
    <Container>
      {/* Hero */}
      <section className="text-white py-32 px-[5%] md:px-[7%] lg:px-[10%] w-full bg-brand-steel text-white">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-2">
          <h1 className="text-[32px] md:text-[48px] font-bold">Tentang Kami</h1>
